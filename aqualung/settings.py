...
SECRET_KEY = 'r0pbd16z@7yzuw(vf9#)$wb-0(x3eh9r*q8sctu3*zh*km=qml'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'catalogApp.context_processors.general_info'
            ],
        },
    },
]

WSGI_APPLICATION = 'aqualung.wsgi.application'
